# ColdRAG (Official Implementation)
...
# 1. ColdRAG Framework Overview

We include the complete system architecture in:

📄 **ColdRAG.pdf**  
(See file inside this repository.)
...
python -m vllm.entrypoints.openai.api_server \
  ...
  --download-dir "$CACHE_DIR"
```
# 4. Dataset & Knowledg Graph Setup
