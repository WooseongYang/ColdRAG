...
from coldrag.utils import get_env_value

from coldrag.kg import (
    STORAGES,
    verify_storage_implementation,
)


from coldrag.kg.shared_storage import (
    get_namespace_data,
...
from coldrag.namespace import NameSpace
from coldrag.operate import (
...
from coldrag.constants import GRAPH_FIELD_SEP
...
from coldrag.types import KnowledgeGraph
...
class LightRAG:
    ...
    def _get_storage_class(self, storage_name: str) -> Callable[..., Any]:
        ...
        if storage_name == "JsonKVStorage":
            from coldrag.kg.json_kv_impl import JsonKVStorage

            return JsonKVStorage
        elif storage_name == "NanoVectorDBStorage":
            from coldrag.kg.nano_vector_db_impl import NanoVectorDBStorage

            return NanoVectorDBStorage
        elif storage_name == "NetworkXStorage":
            from coldrag.kg.networkx_impl import NetworkXStorage

            return NetworkXStorage
        elif storage_name == "JsonDocStatusStorage":
            from coldrag.kg.json_doc_status_impl import JsonDocStatusStorage
    ...
    async def aquery_data(
        ...
        if data_param.mode in ["local", "global", "hybrid", "mix", "coldrag"]:
    ...
    async def aquery_llm(
        ...
        try:
            ...
            if param.mode in ["local", "global", "hybrid", "mix", "coldrag"]:
                query_result = await kg_query(
                    query.strip(),
                    self.chunk_entity_relation_graph,
                    self.entities_vdb,
    ...
    async def adelete_by_entity(self, entity_name: str) -> DeletionResult:
        ...
        Returns:
            DeletionResult: An object containing the outcome of the deletion process.
        """
        from coldrag.utils_graph import adelete_by_entity
    ...
    async def adelete_by_relation(
        ...
        Returns:
            DeletionResult: An object containing the outcome of the deletion process.
        """
        from coldrag.utils_graph import adelete_by_relation
    ...
    async def get_entity_info(
        ...
        from coldrag.utils_graph import get_entity_info
    ...
    async def get_relation_info(
        ...
        from coldrag.utils_graph import get_relation_info
    ...
    async def aedit_entity(
        ...
        """
        from coldrag.utils_graph import aedit_entity
    ...
    async def aedit_relation(
        ...
        """
        from coldrag.utils_graph import aedit_relation
    ...
    async def acreate_entity(
        ...
        """
        from coldrag.utils_graph import acreate_entity
    ...
    async def acreate_relation(
        ...
        """
        from coldrag.utils_graph import acreate_relation
    ...
    async def amerge_entities(
        ...
        """
        from coldrag.utils_graph import amerge_entities
    ...
    async def aexport_data(
        ...
        """
        from coldrag.utils import aexport_data as utils_aexport_data
